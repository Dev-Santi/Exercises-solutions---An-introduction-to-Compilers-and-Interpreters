...
public class DFun  extends Def {
  ...
  public <R,A> R accept(c_like.Absyn.Def.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof c_like.Absyn.DFun) {
      c_like.Absyn.DFun x = (c_like.Absyn.DFun)o;
